...
public class MySocket_2 {
    ...
    /** 单键实例 */
    private static MySocket_2 gTcp;
    ...
    /** 读取buff的大小 */
    public static final int READ_BUFF_SIZE = 1024*1024*5;
    ...
    public static synchronized MySocket_2 instance(Handler Handler) {
        if ( gTcp == null ) {
            gTcp = new MySocket_2();
            mHandler=Handler;
        }
                        ...
                        if ( sk.isReadable() ) {
                            ...
                            if ( nLen > 0 ) {
                                if ( mEventListener != null ) {
                                    ...
                                    Log.e("kcrx_lock","rev:" + info);

                                    Message msg=new Message();
                                    msg.what=2;
                                    Bundle bundle=new Bundle();
                                    bundle.putByteArray("socketmsg",read.toByteArray());
                                    msg.setData(bundle);
