...
//    private ArrayList<Fragment> fragments;
    ...
    protected void onResume() {
        ...
        Log.e("main","main mUhfrManager is get!");
        if(mUhfrManager!=null){
            mUhfrManager.setPower(mSharedPreferences.getInt("readPower",33), mSharedPreferences.getInt("writePower",33));//set uhf module power
